...
I propose that the combination of large scale, unsupervisedly trained models of cultural material ("foundation models") with progress in manifold learning enables novel approaches in a number of social sciencea





# Many concepts in Soc Sci Humanities


Are drawn from Spatial metaphors that correspond to manifolds. 
...
* This is not research, but an example, to make things more tangible
...
tda mapper, Dreams UMAP PACmap STARmap, Isomap, PAGA
...
* another way of looking at this: Let's do AI interpreatbility to ourselves.
